...
Lesson.all.each do |lesson|
  lesson.surveys.create!([
    {respondent_name: "Bill Nye", lo_rating: rand(5..10), delivery_rating: rand(5..10), comfort_rating: rand(5..10), positive_comment: positive_comments.sample, negative_comment: negative_comments.sample, general_comment: general_comments.sample, attended_office_hours: [true, false].sample},
    {respondent_name: "Barack Obama", lo_rating: rand(5..10), delivery_rating: rand(5..10), comfort_rating: rand(5..10), positive_comment: positive_comments.sample, negative_comment: negative_comments.sample, general_comment: general_comments.sample, attended_office_hours: [true, false].sample},
    {respondent_name: "George Washington", lo_rating: rand(5..10), delivery_rating: rand(5..10), comfort_rating: rand(5..10), positive_comment: positive_comments.sample, negative_comment: negative_comments.sample, general_comment: nil, attended_office_hours: [true, false].sample},
    {respondent_name: "Albert Einstein", lo_rating: rand(5..10), delivery_rating: rand(5..10), comfort_rating: rand(5..10), positive_comment: positive_comments.sample, negative_comment: negative_comments.sample, general_comment: general_comments.sample, attended_office_hours: [true, false].sample},
    {respondent_name: "Neil Armstrong", lo_rating: rand(5..10), delivery_rating: rand(5..10), comfort_rating: rand(5..10), positive_comment: positive_comments.sample, negative_comment: negative_comments.sample, general_comment: nil, attended_office_hours: [true, false].sample},
    {respondent_name: "Katie Couric", lo_rating: rand(5..10), delivery_rating: rand(5..10), comfort_rating: rand(5..10), positive_comment: positive_comments.sample, negative_comment: negative_comments.sample, general_comment: general_comments.sample, attended_office_hours: [true, false].sample},
    {respondent_name: "Duke Ellington", lo_rating: rand(5..10), delivery_rating: rand(5..10), comfort_rating: rand(5..10), positive_comment: positive_comments.sample, negative_comment: negative_comments.sample, general_comment: general_comments.sample, attended_office_hours: [true, false].sample},
    {respondent_name: "Marvin Gaye", lo_rating: rand(5..10), delivery_rating: rand(5..10), comfort_rating: rand(5..10), positive_comment: positive_comments.sample, negative_comment: negative_comments.sample, general_comment: nil, attended_office_hours: [true, false].sample},
    {respondent_name: "Euphemia Hayes", lo_rating: rand(5..10), delivery_rating: rand(5..10), comfort_rating: rand(5..10), positive_comment: positive_comments.sample, negative_comment: negative_comments.sample, general_comment: general_comments.sample, attended_office_hours: [true, false].sample},
    {respondent_name: "Anonymous", lo_rating: rand(5..10), delivery_rating: rand(5..10), comfort_rating: rand(5..10), positive_comment: positive_comments.sample, negative_comment: negative_comments.sample, general_comment: nil, attended_office_hours: [true, false].sample}
  ])
end
